...
while True:
    ...
    if move[0] == "use":
        if "block of c4" in inventory and currentRoom == "Kitchen" and move[1] == "block of c4":
            print("You arm your C4 and blast a hole in the wall revealing a shining path to Valhalla!")
            rooms["Kitchen"]["east"]= "Valhalla"
            inventory.remove("block of c4")

    if move[0] == "use":
        if "siren" in inventory and currentRoom == "Mine Shaft" and move[1] == "siren":
            print("You use the siren and crumble the wall, deafening your ears but showering your eyes with the stunning awe of Valhalla!")
